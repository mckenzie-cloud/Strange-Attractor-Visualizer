...
public:
    ...
    ///
    ///  ** On Windows and macOS, long double-headed arrows are used
    ///
    ////////////////////////////////////////////////////////////
    enum Type
    {
        ...
        SizeHorizontal,         //!< Horizontal long double arrow cursor
        SizeVertical,           //!< Vertical long double arrow cursor
        SizeTopLeftBottomRight, //!< long double arrow cursor going from top-left to bottom-right
        SizeBottomLeftTopRight, //!< long double arrow cursor going from bottom-left to top-right
